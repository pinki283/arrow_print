...
if (isset($_POST['submit'])) {
    ...
    $title = mysqli_real_escape_string($conn, $_POST['option']);

    

    // Insert product data into the database
    $sql = "INSERT INTO select_option (form_field_id,product_id,sub_category_id, main_category_id, select_option_name) VALUES ('$formDetails', $productId,'$subCategory', '$mainCategory', '$title')";
    ...
    <select name="product" id="product" class="form-control">
        <option value="">Choose Option</option>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="option" placeholder="Enter Select Option" required>
                    </div>
