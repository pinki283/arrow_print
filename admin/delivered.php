...
echo'
                          ...
                          if ($status == 0) {
                            ...
                            echo "Unknown"; 
                                                ...
                                                <td class="text-center">
                                                <button type="button" id="PopoverCustomT-1" class=" btn-sm"><a href="update_delivered.php?update_id='.$id.'"><input type="submit" value="Update"></a></button>
                                                  <button type="button" id="PopoverCustomT-1" class=" btn-sm"><a href="delete_delivered.php?delete_id='.$id.'">Delete</a></button>
                                            </td>
                                            </tr>';
                                            $i++;
                                            }
