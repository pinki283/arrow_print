...
if(isset($_GET['update_id'])) {
    ...
    $sql = "SELECT * FROM form_details WHERE form_field_id='$id'";
...
<body>
            ...
            <div class="col-lg-8">
                <form action="" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="sub_category">Products</label>
    ...
    if(isset($_POST['update'])) {
        ...
        $category = $_POST['sub_cat'];
                ...
                $sql = "UPDATE form_details SET form_field_name='$title'WHERE product_id='$id'";
                $result = mysqli_query($conn, $sql);
